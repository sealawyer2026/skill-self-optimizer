...
description: "Meta-skill for fully automated skill optimization. Use when: (1) Skill triggers incorrectly, (2) User reports issues, (3) Pre-ClawHub review, (4) Version iteration, (5) Applying Google's 5 design patterns, (6) Want fully automatic optimization pipeline. Implements Tool Wrapper, Generator, Reviewer, Inversion, and Orchestrator patterns."
version: "3.0.0"
changelog:
